...
configure_alsa() {
    ...
    echo "📢 Speaker: card $SPEAKER_CARD"
    echo "🎤 Microphone: card $MIC_CARD"
...
EOF
    ...
    echo "✓ ALSA configured with rate conversion: ~/.asoundrc"
}
...
if [ -f ".venv_ml/bin/python" ]; then
    echo "🐍 Using ML Vision environment (.venv_ml)"
    PYTHON_CMD=".venv_ml/bin/python"
